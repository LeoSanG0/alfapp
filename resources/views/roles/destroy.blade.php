<!-- Modal -->
<div class="modal fade" id="modal_delete_role" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer border-0">
                ...
                <button type="button" class="btn btn-primary btn-delete-role">Eliminar</button>
            </div>
        </div>
    </div>
</div>